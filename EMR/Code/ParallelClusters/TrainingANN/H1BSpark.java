...
public class H1BSpark {
    ...
    @Parameter(names = "-id", description = "ID for Parameter sets")
    private String id = "0";
    ...
    protected void entryPoint(String[] args) throws Exception {
        ...
        String hyperParams = learningRate + "\t" + mtn + "\t" + numHiddenNodes + "\t" 
        			+ numEpochs + "\t" + batchSizePerWorker + "\t" + iter;
        upload.run(id, hyperParams, evaluation.stats());
